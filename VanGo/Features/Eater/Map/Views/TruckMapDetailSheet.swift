...
struct TruckMapDetailSheet: View {
    ...
    var body: some View {
        VStack(spacing: 12) {
            // Drag indicator
            Capsule()
                .fill(Color.vangoSlate.opacity(0.4))
            ...
            HStack(spacing: 12) {
                NavigationLink(value: truck) {
                    Label("View Menu", systemImage: "menucard")
                        ...
                        .padding(.vertical, 12)
                        .background(Color.vangoSun, in: RoundedRectangle(cornerRadius: 12))
                }
                ...
                Button {
                    ...
                    Label("Directions", systemImage: "arrow.triangle.turn.up.right.diamond.fill")
                        ...
                        .frame(maxWidth: .infinity)
                        .padding(.vertical, 12)
                        .background(Color.vangoSun.opacity(0.12), in: RoundedRectangle(cornerRadius: 12))
                }
            }
            .padding(.horizontal, 16)
            .padding(.bottom, 16)
