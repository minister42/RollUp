            ...
            VStack(spacing: 20) {
                    ...
                    HStack {
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            if truck.tier == .pro {
                                ...
                                .foregroundStyle(isOpen ? .vangoOlive : .secondary)
                            }
                        }
                ...
                .background(
                    RoundedRectangle(cornerRadius: 16)
                        .fill(isOpen ? Color.vangoOlive.opacity(0.08) : Color.vangoMist)
                )
                .overlay(
                    RoundedRectangle(cornerRadius: 16)
                        .stroke(isOpen ? Color.vangoOlive.opacity(0.3) : Color.clear, lineWidth: 1)
                )
                ...
                HStack(spacing: 12) {
                    ...
                    StatCard(value: "3", label: "Coupons", icon: "ticket.fill", color: .vangoSun)
                }
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    NavigationLink {
                        ...
                        QuickActionRow(icon: "megaphone.fill", title: "Promote Truck", subtitle: "Boost your visibility", color: .vangoSun)
                    }
                }
