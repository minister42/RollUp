        ...
        VStack(alignment: .leading, spacing: 10) {
            HStack {
                Image(systemName: template.icon)
                    ...
                    .background(Color.vangoSun.opacity(0.12), in: RoundedRectangle(cornerRadius: 10))
                ...
                Text("\(template.durationDays) days")
                    ...
                    .padding(.horizontal, 8)
                    .padding(.vertical, 4)
                    .background(Color.vangoMist, in: Capsule())
            }
            ...
            HStack {
                ...
                Button(action: onPurchase) {
                    Text("Get Started")
                        ...
                        .padding(.vertical, 8)
                        .background(Color.vangoSun, in: RoundedRectangle(cornerRadius: 10))
                }
            }
        }
        .padding(14)
    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 24) {
                ...
                .padding(16)
                .background(Color.vangoMist, in: RoundedRectangle(cornerRadius: 14))
