        ...
        ScrollView {
            VStack(spacing: 20) {
                ...
                VStack(spacing: 8) {
                    ...
                    Text("Get the most out of RollUp for your food truck")
                        .font(.subheadline)
    ...
    var body: some View {
            ...
            ForEach(tier.features) { feature in
                HStack(spacing: 8) {
                    Image(systemName: feature.included ? "checkmark.circle.fill" : "xmark.circle.fill")
                        .font(.subheadline)
                        .foregroundStyle(feature.included ? .rollUpGreen : Color.rollUpGray.opacity(0.5))
            ...
            if !isCurrentTier {
                Button(action: onSelect) {
                    Text(tier == .pro ? "Upgrade to Pro" : "Downgrade to Basic")
                        ...
                        .padding(.vertical, 12)
                        .background(
                            tier == .pro ? Color.rollUpOrange : Color.rollUpGray,
        ...
        .overlay(
            RoundedRectangle(cornerRadius: 16)
                .stroke(isCurrentTier ? Color.rollUpOrange : Color.rollUpLightGray, lineWidth: isCurrentTier ? 2 : 1)
        )
    }
}
