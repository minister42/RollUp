# RollUp 6-Month Strategic Feature Roadmap
...
**Deal Discovery (RollUp Differentiator)**
...
**Coupon/Deal Management (RollUp Revenue Driver)**
...
- Revenue share tracking (RollUp cut vs. vendor)
...
| Vendor community | 3 | Truckster only competitor; but RollUp has better consumer integration |
| Weather integration | 3 | Unique; addresses weather-dependent business model |
| Catering/event booking | 3 | Roaming Hunger focus; but RollUp integrates with discovery |

---

## Phase 1 MVP Launch Readiness

By end of Phase 1 (Month 2), RollUp will have:
